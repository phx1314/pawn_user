...
////			TRIANGLE_WIDHT/2是tab的中心点
//			Paint mPaint = new Paint();
//			mPaint.setAntiAlias(true);
//			mPaint.setColor(STROKE_COLOR);
//			mPaint.setStyle(Style.FILL);
//			mPaint.setStrokeWidth(STROKE_WIDHT);
////			canvas.drawRect(-(tabWidth/2-TRIANGLE_WIDHT),-8, tabWidth/2, 0, mStrokePaint);
//			canvas.drawLine(-(tabWidth/2-TRIANGLE_WIDHT),-5, tabWidth/2, -5, mStrokePaint);
//			canvas.restore();
//		}
	}
