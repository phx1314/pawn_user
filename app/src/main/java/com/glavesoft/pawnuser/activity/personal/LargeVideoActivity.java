...
import com.glavesoft.pawnuser.adapter.LargeImageAdapter;
...
/**
 * Created by Sinyu on 2018/12/18.
 */

public class LargeVideoActivity extends BaseActivity implements ViewPager.OnPageChangeListener, View.OnClickListener  {
    ...
    private final int RESULT_CODE_LARGE_IMAGE = 3;
    @Override
    ...
    public void initView() {
        ...
        if (bundle != null) {
            ...
            imgUrls = bundle.getStringArrayList(KEY_IMAGE_LIST);
    ...
    public void onBackPressed() {
        ...
        intent.putStringArrayListExtra(KEY_IMAGE_LIST, (ArrayList<String>) adapter.getData());
