...
import com.glavesoft.pawnuser.fragment.MySendCallFragment;
import com.glavesoft.pawnuser.fragment.SendCallFindFragment;
 ...
 * @company:常州宝丰
 */
public class SendCallActivity extends BaseActivity {
    ...
    BroadcastReceiver mListenerID = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            if (SobotApi.getUnreadMsg(SendCallActivity.this, LocalData.getInstance().getUserInfo
                    ().getId()) == 0) {
    ...
    public void onResume() {
        ...
        if (SobotApi.getUnreadMsg(SendCallActivity.this, LocalData.getInstance().getUserInfo()
            ...
            tv_evaluation_kf.setVisibility(View.VISIBLE);
            tv_evaluation_kf.setText(SobotApi.getUnreadMsg(SendCallActivity.this, LocalData
    ...
    private void initView() {
        setTitleBack();
        setTitleName("寄卖");
        setTitleNameEn(R.mipmap.consignment);

        titlebar_kf = (ImageView) findViewById(R.id.titlebar_kf);
        titlebar_kf.setVisibility(View.VISIBLE);
        titlebar_kf.setImageResource(R.mipmap.sc);
        titlebar_kf.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent intent=new Intent(SendCallActivity.this,SendCallCollectionActivity.class);
        ...
        tvSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(SendCallActivity.this,SendCallSearchActivity.class);
                startActivity(intent);
            }
        });
...
//        });
        ...
        fragment.add(SendCallFindFragment.newInstance(0));
        fragment.add(MySendCallFragment.newInstance(1));
