...
//            finish();
            ...
            resolutionMap1.put("width",screenWidth);
            resolutionMap1.put("height",screenHeight);
            startActivity(new Intent(this, OpenglActivity.class)
                    .putExtra("isStartRecorder", false).putExtra("is3DPose", false)
                    .putExtra("isdebug", false).putExtra("ROIDetect", false)
                    .putExtra("is106Points", false).putExtra("isBackCamera", false)
                    .putExtra("faceSize", 200).putExtra("interval", 100)
                    .putExtra("resolution", resolutionMap1).putExtra("isFaceProperty", false)
                    .putExtra("isOneFaceTrackig", true)
                    .putExtra("trackModel", "Normal")
                    .putExtra("type", type));
