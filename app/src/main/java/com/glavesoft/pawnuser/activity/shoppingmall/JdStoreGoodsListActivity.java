 ...
 * @company:常州宝丰
 */
public class JdStoreGoodsListActivity extends BaseActivity implements BGARefreshLayout.BGARefreshLayoutDelegate{
...
//                        startActivity(intent);
    ...
    private void showList(ArrayList<StoreGoodsInfo> result) {
        ...
        if (commAdapter == null) {
            list = result;
            commAdapter = new CommonAdapter<StoreGoodsInfo>(JdStoreGoodsListActivity.this, result,
...
//                        getImageLoader().displayImage(BaseConstant.Image_URL + list.get(0),iv_pic_storegoodslist,getImageLoaderOptions());
//                    }else{
...
//                    if(state.equals("rz")){
//                        helper.setText(R.id.tv_state_storegoodslist,"认证商城");
//                        helper.getView(R.id.tv_state_storegoodslist).setBackgroundResource(R.drawable.shape_yellow);
//                    }else{
//                        helper.setText(R.id.tv_state_storegoodslist,"绝当商城");
//                        helper.getView(R.id.tv_state_storegoodslist).setBackgroundResource(R.drawable.shape_red);
//
//                        if(item.getType().equals("0")){//不是竞拍
//                            helper.setText(R.id.tv_price_storegoodslist1,"售价：");
//                        }else{
//                            helper.setText(R.id.tv_price_storegoodslist1,"当前价：");
//                        }
//
//                    }
