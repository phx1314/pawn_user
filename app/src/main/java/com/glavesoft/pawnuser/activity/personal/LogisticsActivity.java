...
import com.glavesoft.pawnuser.fragment.LogisticsFragment;
...
public class LogisticsActivity extends BaseActivity {
    ...
    private final String[] titles = { "寄往平台", "平台取回"};
    private int pos=1;
    ...
    private void initView() {
        setTitleBack();
        setTitleName("物流信息");
        setTitleNameEn(R.mipmap.logistics_information);

        mViewPager = (ViewPager) findViewById(R.id.vp_goods);
        mScrollingTabs = (TriangleScrollingTabs)findViewById(R.id.stv_goods);

        fragment.add(LogisticsFragment.newInstance(0));
        fragment.add(LogisticsFragment.newInstance(1));
