...
//    private final static String LENGTH_ERROR="身份证长度必须为15或者18位！";
    private final static String LENGTH_ERROR="身份证长度必须为18位！";
...
//    private final static String CHECKCODE_ERROR="身份证最后一位校验码有误！";
    private final static String DATE_ERROR="身份证号格式不正确 !";
    private final static String AREA_ERROR="身份证号格式不正确 !";
    private final static String CHECKCODE_ERROR="身份证号格式不正确 !";
    //是否需要返回自动补全成的身份证
    ...
    public static String validate_effective(String idcardNumber){
        ...
        if(Ai.length()==18){//app只能输入18位的身份证号码，新需求。
            //如果为15位则自动补全到18位
    ...
    public static void main(String[] args) {
        System.out.println(validate_effective("320311770706001"));
//        System.out.println(validate_effective("431025930428321", true));
//        System.out.println(validate_effective("421181198803139479"));
    }
}