...
public class JCVideoPlayerStandard extends JCVideoPlayer {
    ...
    private  void setBroadcast(String action,String type){
...
//            if(JCVideoPlayerManager.getSecondFloor()==null||(JCVideoPlayerManager.getSecondFloor().currentScreen!= JCVideoPlayerStandard.SCREEN_WINDOW_FULLSCREEN)){
//                setBroadcast("to_SingleVideo","finish");
//            }else{
                backPress();
//            }
