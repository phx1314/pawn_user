...
//        }, 500);
    ...
    private void init() {
        ...
        enterBtn = (Button) findViewById(R.id.landmark_enterBtn);
...
//            prviewSizeList = parameter.getSupportedPreviewSizes();
...
//            int index=bestVideoSize(screenWidth);
//
//            videoWidth1=videoSizeList.get(index).width;
//            videoHeight1=videoSizeList.get(index).height;
//            System.out.println(videoWidth1+"      "+videoHeight1);
...
//            System.out.println(videoWidth1+"      "+videoHeight1);
            ...
            HashMap<String, Integer> resolutionMap1=new HashMap<>();
            resolutionMap1.put("width",720);
            resolutionMap1.put("height",1280);
            startActivity(new Intent(FaceppActionActivity.this, OpenglActivity.class)
                    ...
                    .putExtra("resolution", resolutionMap1).putExtra("isFaceProperty", isFaceProperty)
